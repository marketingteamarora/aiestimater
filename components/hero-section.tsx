            ...
            <div className="relative group">
              ...
              <div className="relative flex flex-col sm:flex-row gap-3 p-3 bg-white rounded-2xl shadow-2xl">
                ...
                <Button
                  ...
                  className="w-full sm:w-auto bg-accent text-primary hover:bg-gold-dark font-bold text-lg px-8 py-4 sm:py-6 shadow-lg hover:shadow-xl transition-all disabled:opacity-50"
                >
