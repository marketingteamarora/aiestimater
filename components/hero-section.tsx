      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full backdrop-blur-md">
            ...
            <span className="text-sm font-medium tracking-wide text-white uppercase">AI-Powered Valuations</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold text-white leading-[1.1] tracking-tight text-balance">
            Know Your Home's Value in{" "}
            <span className="text-accent italic font-serif">Seconds</span>
          </h1>

          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto text-pretty font-light leading-relaxed">
          ...
          <form onSubmit={handleSubmit} className="max-w-3xl mx-auto pt-8">
            <div className="relative flex flex-col sm:flex-row gap-3 p-2 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 shadow-2xl">
              ...
              <Button
                ...
                className="w-full sm:w-auto bg-accent text-primary hover:bg-gold-dark font-semibold text-lg px-8 h-14 rounded-xl shadow-lg transition-all disabled:opacity-50"
              >
