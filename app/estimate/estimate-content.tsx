...
export default function EstimateContent() {
  ...
  const searchedAddress = searchParams.get("address") || searchParams.get("fullAddress")
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12 space-y-6">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto">
              Our AI needs just a few details to calculate your accurate home value estimate.
          ...
          <PropertyForm
            ...
            fullAddress={searchParams.get("address") || searchParams.get("fullAddress") || ""}
          />
        </div>
      </div>
    </div>
