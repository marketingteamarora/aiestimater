...
export const cityMarketData: Record<string, CityConfig> = {
  brampton: {
    name: "Brampton",
    slug: "brampton",
    region: "Peel Region",
...
export const citySlugs = Object.keys(cityMarketData)

export function getCityMarket(slug: string): CityConfig | undefined {
  return cityMarketData[slug]
}
